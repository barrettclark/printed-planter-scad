...
# "intertwine", "islamic_star", "rhombille", "cairo_pentagonal" and
# "floret_pentagonal" abort CGAL at some
...
# cairo_pentagonal, floret_pentagonal) wash out to near-invisible outlines. 25/25 rakes the light
...
# README documents as clean for all six fragile patterns, and the one a
